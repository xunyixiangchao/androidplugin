        ...
        try {
            ...
            mCallbackField.set(mH, new Handler.Callback() {
                ...
                public boolean handleMessage(Message msg) {
                    Log.e("plugin", "handleMessage: what" + msg.what);
                    //将Intent替换回来
                    switch (msg.what) {
                        case 100:
                            //获取ActivityClientRecord中的intent对象
                            try {
                                Log.e("plugin", "handleMessage: msg.obj" + msg.obj);
//                                Field mActivitiesField = aClass.getDeclaredField("mActivities");
//                                mActivitiesField.setAccessible(true);
//                                ArrayMap<IBinder, Object> mActivities = (ArrayMap<IBinder, Object>) mActivitiesField.get(activityThread);
//                                Object o = mActivities.get(msg.obj);
//                                Field intentField = o.getClass().getDeclaredField("intent");
//                                intentField.setAccessible(true);
//                                Intent proxyIntent = (Intent) intentField.get(o);
                                //获取ActivityClientRecord中的intent对象
